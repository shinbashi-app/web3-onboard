...
const intiOnboard = async (theme) => {
  const { default: Onboard } = await import('@shinbashi/core')
  const { default: injectedModule } = await import('@shinbashi/injected-wallets')
  const { default: trezorModule } = await import('@shinbashi/trezor')
  const { default: ledgerModule } = await import('@shinbashi/ledger')
  const { default: walletConnectModule } = await import('@shinbashi/walletconnect')
  const { default: infinityWalletModule } = await import('@shinbashi/infinity-wallet')
  const { default: coinbaseModule } = await import('@shinbashi/coinbase')
  const { default: dcentModule } = await import('@shinbashi/dcent')
  const { default: portisModule } = await import('@shinbashi/portis')
  const { default: magicModule } = await import('@shinbashi/magic')
  const { default: keystoneModule } = await import('@shinbashi/keystone')
  const { default: fortmaticModule } = await import('@shinbashi/fortmatic')
  const { default: keepkeyModule } = await import('@shinbashi/keepkey')
  const { default: gnosisModule } = await import('@shinbashi/gnosis')
  const { default: sequenceModule } = await import('@shinbashi/sequence')
  const { default: tahoModule } = await import('@shinbashi/taho')
  const { default: enkryptModule } = await import('@shinbashi/enkrypt')
  const { default: mewWalletModule } = await import('@shinbashi/mew-wallet')
  const { default: torusModule } = await import('@shinbashi/torus')
  const { default: uauthModule } = await import('@shinbashi/uauth')
  const { default: trustModule } = await import('@shinbashi/trust')
  const { default: xdefiModule } = await import('@shinbashi/xdefi')
  const { default: cedeModule } = await import('@shinbashi/cede-store')
  const { default: frameModule } = await import('@shinbashi/frame')
  const { default: arcanaModule } = await import('@shinbashi/arcana-auth')
  const { default: bloctoModule } = await import('@shinbashi/blocto')
  const { default: venlyModule } = await import('@shinbashi/venly')
