...
**NPM**
`npm i @shinbashi/react @shinbashi/injected-wallets ethers`

**Yarn**
`yarn add @shinbashi/react @shinbashi/injected-wallets ethers`
...
The `init` function must be called before any hooks can be used. The `init` function just initializes `web3-onboard` and makes it available for all hooks to use. For reference check out the [initialization docs for `@shinbashi/core`](../core/README.md#initialization)
...
For full Notification documentation please see [Notify section within the `@shinbashi/core` docs](../core/README.md#options)
